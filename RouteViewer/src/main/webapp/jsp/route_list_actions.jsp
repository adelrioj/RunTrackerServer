...
<liferay-ui:icon-menu>
    ...
    <portlet:renderURL var="viewRouteURL">
        <portlet:param name="selectedRouteId" value="<%= String.valueOf(route.getRouteId()) %>" />
    </portlet:renderURL>
    <liferay-ui:icon image="view" message="view" url="${viewRouteURL}" />
    <!--Edit section -->
    <portlet:renderURL var="editRouteURL">
        <portlet:param name="routeId" value="<%= String.valueOf(route.getRouteId()) %>" />
    ...
    <portlet:actionURL name="deleteRouteAction" var="deleteRouteURL">
        <portlet:param name="deleteRouteId" value="<%= String.valueOf(route.getRouteId()) %>" />
    </portlet:actionURL>
