		...
		<%
			...
			if (themeDisplay.isShowMyAccountIcon() && (themeDisplay.getURLMyAccount() != null)) {
				...
				if (PropsValues.DOCKBAR_ADMINISTRATIVE_LINKS_SHOW_IN_POP_UP) {
					signedInAs = "<a class=\"signed-in\" href=\"javascript:Liferay.Util.openWindow({dialog: {destroyOnHide: true}, "
							+ "title: '" + HtmlUtil.escapeJS(LanguageUtil.get(pageContext, "my-account"))
							+ "', uri: '" + HtmlUtil.escapeJS(myAccountURL)
							+ "'});\">" + signedInAs + "</a>";
				}
				else {
		...
		<div class="container-fluid">
			...
			<div class="row-fluid">
				<div class="span4 offset4">
					<h1 class="text-center">RunTracker</h1>
				</div>
			</div>
			...
			<div class="row-fluid" >
				...
				<div class="span2 offset4 hidden-phone">
					<img src="/html/portlet/login/images/login-side-image.jpg" class="img-rounded pull-right">
				</div>
				...
				<div class="span2">
					...
					<aui:form action="<%= loginURL %>"
						...
						<aui:button-row>
							<aui:button cssClass="fill-width btn-large"
										type="submit"
										value="sign-in" />
						</aui:button-row>
					</aui:form>
