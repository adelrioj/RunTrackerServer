 ...
 * @generated
 */
public class RouteLocationLocalServiceClp implements RouteLocationLocalService {
    ...
    public RouteLocationLocalServiceClp(
        ...
        _methodName19 = "generateNewIdRouteLocation";

        _methodParameterTypes19 = new String[] { "long" };

        _methodName20 = "createRouteLocation";
    ...
    public es.eina.tfg.model.RouteLocation addRouteLocation(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(routeLocation) });
        } catch (Throwable t) {
    ...
    public es.eina.tfg.model.RouteLocation createRouteLocation(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] { ClpSerializer.translateInput(routeLocationPK) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public es.eina.tfg.service.persistence.RouteLocationPK generateNewIdRouteLocation(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    _methodParameterTypes19, new Object[] { idRoute });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
        ...
        return (es.eina.tfg.service.persistence.RouteLocationPK) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public es.eina.tfg.model.RouteLocation createRouteLocation(long idRoute,
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName20,
                    ...
                    new Object[] { idRoute, idRouteLocation });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
