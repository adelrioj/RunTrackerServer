...
/**
 * Provides the local service interface for UserAndRoute. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author adelrioj
 * @see UserAndRouteLocalServiceUtil
...
public interface UserAndRouteLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link UserAndRouteLocalServiceUtil} to access the user and route local service. Add custom service methods to {@link es.eina.tfg.service.impl.UserAndRouteLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
