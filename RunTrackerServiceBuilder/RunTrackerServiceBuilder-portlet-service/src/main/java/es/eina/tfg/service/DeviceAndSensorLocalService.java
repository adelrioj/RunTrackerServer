...
/**
 * Provides the local service interface for DeviceAndSensor. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author adelrioj
 * @see DeviceAndSensorLocalServiceUtil
...
public interface DeviceAndSensorLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link DeviceAndSensorLocalServiceUtil} to access the device and sensor local service. Add custom service methods to {@link es.eina.tfg.service.impl.DeviceAndSensorLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
