...
/**
 * Provides the remote service interface for Power. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author adelrioj
 * @see PowerServiceUtil
...
public interface PowerService extends BaseService, InvokableService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link PowerServiceUtil} to access the power remote service. Add custom service methods to {@link es.eina.tfg.service.impl.PowerServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
