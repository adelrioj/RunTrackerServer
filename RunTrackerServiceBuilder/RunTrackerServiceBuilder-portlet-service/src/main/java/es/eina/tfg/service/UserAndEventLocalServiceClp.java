 ...
 * @generated
 */
public class UserAndEventLocalServiceClp implements UserAndEventLocalService {
    ...
    public es.eina.tfg.model.UserAndEvent addUserAndEvent(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(userAndEvent) });
        } catch (Throwable t) {
    ...
    public es.eina.tfg.model.UserAndEvent createUserAndEvent(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] { ClpSerializer.translateInput(userAndEventPK) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
