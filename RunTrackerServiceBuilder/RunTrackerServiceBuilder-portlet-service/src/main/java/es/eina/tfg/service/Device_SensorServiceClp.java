 ...
 * @generated
 */
public class Device_SensorServiceClp implements Device_SensorService {
	public Device_SensorServiceClp(InvokableService invokableService) {
		...
		_methodName6 = "getDeviceSensor";

		_methodParameterTypes6 = new String[] { "java.lang.Long", "java.lang.Long" };

		_methodName7 = "findByDeviceId";

		_methodParameterTypes7 = new String[] { "java.lang.Long" };

		_methodName8 = "findActiveSensors";
	...
	public es.eina.tfg.model.Device_Sensor add(java.lang.Long deviceId,
		...
		return (es.eina.tfg.model.Device_Sensor)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<es.eina.tfg.model.Device_Sensor> findByDeviceId(
		...
		return (java.util.List<es.eina.tfg.model.Device_Sensor>)ClpSerializer.translateOutput(returnObj);
	}
