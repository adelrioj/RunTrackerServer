 ...
 * @generated
 */
public class RaceLocalServiceClp implements RaceLocalService {
    ...
    public RaceLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName21 = "getByIdUserAndTimeRange";

        _methodParameterTypes21 = new String[] {
                "long", "java.util.Date", "java.util.Date", "int", "int"
            };

        _methodName22 = "getLastRace";

        _methodParameterTypes22 = new String[] { "long" };

        _methodName23 = "getLocations";
    ...
    public es.eina.tfg.model.Race addRace(es.eina.tfg.model.Race race)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(race) });
        } catch (Throwable t) {
    ...
    public es.eina.tfg.model.Race getLastRace(long idUser)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName22,
                    _methodParameterTypes22, new Object[] { idUser });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
