 ...
 * @generated
 */
public class UserAndRouteLocalServiceClp implements UserAndRouteLocalService {
    ...
    public es.eina.tfg.model.UserAndRoute addUserAndRoute(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(userAndRoute) });
        } catch (Throwable t) {
    ...
    public es.eina.tfg.model.UserAndRoute createUserAndRoute(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] { ClpSerializer.translateInput(userAndRoutePK) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
