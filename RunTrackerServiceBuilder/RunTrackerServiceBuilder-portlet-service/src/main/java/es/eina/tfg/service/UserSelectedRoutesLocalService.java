...
/**
 * Provides the local service interface for UserSelectedRoutes. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author adelrioj
 * @see UserSelectedRoutesLocalServiceUtil
...
public interface UserSelectedRoutesLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UserSelectedRoutesLocalServiceUtil} to access the user selected routes local service. Add custom service methods to {@link es.eina.tfg.service.impl.UserSelectedRoutesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
