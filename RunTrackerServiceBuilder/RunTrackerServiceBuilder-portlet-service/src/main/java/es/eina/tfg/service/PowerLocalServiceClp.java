 ...
 * @generated
 */
public class PowerLocalServiceClp implements PowerLocalService {
    ...
    public PowerLocalServiceClp(InvokableLocalService invokableLocalService) {
        ...
        _methodName19 = "generateNewIdPower";
    ...
    public es.eina.tfg.model.Power addPower(es.eina.tfg.model.Power power)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(power) });
        } catch (Throwable t) {
    ...
    public es.eina.tfg.model.Power createPower(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] { ClpSerializer.translateInput(powerPK) });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public es.eina.tfg.service.persistence.PowerPK generateNewIdPower(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    _methodParameterTypes19, new Object[] { idRace });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
        ...
        return (es.eina.tfg.service.persistence.PowerPK) ClpSerializer.translateOutput(returnObj);
    }
