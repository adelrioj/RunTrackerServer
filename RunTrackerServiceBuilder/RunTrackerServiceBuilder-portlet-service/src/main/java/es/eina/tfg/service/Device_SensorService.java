...
/**
 * Provides the remote service interface for Device_Sensor. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author adelrioj
 * @see Device_SensorServiceUtil
...
public interface Device_SensorService extends BaseService, InvokableService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link Device_SensorServiceUtil} to access the device_ sensor remote service. Add custom service methods to {@link es.eina.tfg.service.impl.Device_SensorServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
