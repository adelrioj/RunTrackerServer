 ...
 * @generated
 */
public class DeviceAndSensorLocalServiceClp
    ...
    public es.eina.tfg.model.DeviceAndSensor addDeviceAndSensor(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(deviceAndSensor) });
        } catch (Throwable t) {
    ...
    public java.util.List<es.eina.tfg.model.DeviceAndSensor> getDeviceAndSensors(
        ...
        return (java.util.List<es.eina.tfg.model.DeviceAndSensor>) ClpSerializer.translateOutput(returnObj);
    }
