 ...
 * @generated
 */
public class UserSelectedRoutesLocalServiceClp
	implements UserSelectedRoutesLocalService {
	public UserSelectedRoutesLocalServiceClp(
	...
	public es.eina.tfg.model.UserSelectedRoutes addUserSelectedRoutes(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(userSelectedRoutes)
					});
		}
		catch (Throwable t) {
		...
		return (es.eina.tfg.model.UserSelectedRoutes)ClpSerializer.translateOutput(returnObj);
	}
	...
	public es.eina.tfg.model.UserSelectedRoutes createUserSelectedRoutes(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					...
					new Object[] {
						ClpSerializer.translateInput(userSelectedRoutesPK)
					});
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public es.eina.tfg.model.UserSelectedRoutes add(java.lang.Long userId,
		...
		try {
			...
			if (t instanceof es.eina.tfg.RouteAlreadySelectedByUserException) {
				throw (es.eina.tfg.RouteAlreadySelectedByUserException)t;
			}
