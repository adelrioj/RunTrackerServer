...
import es.eina.tfg.service.DeviceAndSensorLocalService;
...
/**
 * Provides the base implementation for the device and sensor local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link es.eina.tfg.service.impl.DeviceAndSensorLocalServiceImpl}.
 * </p>
 *
 * @author adelrioj
 ...
 * @generated
 */
public abstract class DeviceAndSensorLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements DeviceAndSensorLocalService,
        IdentifiableBean {
    ...
    private DeviceAndSensorLocalServiceClpInvoker _clpInvoker = new DeviceAndSensorLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link es.eina.tfg.service.DeviceAndSensorLocalServiceUtil} to access the device and sensor local service.
     */
    ...
    @Override
    public DeviceAndSensor addDeviceAndSensor(DeviceAndSensor deviceAndSensor)
        throws SystemException {
        deviceAndSensor.setNew(true);

        return deviceAndSensorPersistence.update(deviceAndSensor);
    }
     ...
     */
    @Override
    public DeviceAndSensor createDeviceAndSensor(
        DeviceAndSensorPK deviceAndSensorPK) {
        return deviceAndSensorPersistence.create(deviceAndSensorPK);
    }
    ...
    @Override
    public DeviceAndSensor deleteDeviceAndSensor(
        DeviceAndSensorPK deviceAndSensorPK)
        throws PortalException, SystemException {
        return deviceAndSensorPersistence.remove(deviceAndSensorPK);
    }
    ...
    @Override
    public DeviceAndSensor deleteDeviceAndSensor(
        DeviceAndSensor deviceAndSensor) throws SystemException {
        return deviceAndSensorPersistence.remove(deviceAndSensor);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(DeviceAndSensor.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return deviceAndSensorPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return deviceAndSensorPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public DeviceAndSensor fetchDeviceAndSensor(
        DeviceAndSensorPK deviceAndSensorPK) throws SystemException {
        return deviceAndSensorPersistence.fetchByPrimaryKey(deviceAndSensorPK);
    }
     ...
     */
    @Override
    public DeviceAndSensor getDeviceAndSensor(
        DeviceAndSensorPK deviceAndSensorPK)
        throws PortalException, SystemException {
        return deviceAndSensorPersistence.findByPrimaryKey(deviceAndSensorPK);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return deviceAndSensorPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<DeviceAndSensor> getDeviceAndSensors(int start, int end)
        throws SystemException {
        return deviceAndSensorPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getDeviceAndSensorsCount() throws SystemException {
        return deviceAndSensorPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public DeviceAndSensor updateDeviceAndSensor(
        DeviceAndSensor deviceAndSensor) throws SystemException {
        return deviceAndSensorPersistence.update(deviceAndSensor);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("es.eina.tfg.model.DeviceAndSensor",
            deviceAndSensorLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = deviceAndSensorPersistence.getDataSource();
