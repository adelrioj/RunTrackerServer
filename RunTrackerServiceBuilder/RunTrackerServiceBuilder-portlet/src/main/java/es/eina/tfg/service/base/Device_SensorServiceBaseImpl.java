...
import es.eina.tfg.service.Device_SensorService;
...
/**
 * Provides the base implementation for the device_ sensor remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link es.eina.tfg.service.impl.Device_SensorServiceImpl}.
 * </p>
 *
 * @author adelrioj
 ...
 * @generated
 */
public abstract class Device_SensorServiceBaseImpl extends BaseServiceImpl
	implements Device_SensorService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link es.eina.tfg.service.Device_SensorServiceUtil} to access the device_ sensor remote service.
	 */
	...
	private Device_SensorServiceClpInvoker _clpInvoker = new Device_SensorServiceClpInvoker();
}