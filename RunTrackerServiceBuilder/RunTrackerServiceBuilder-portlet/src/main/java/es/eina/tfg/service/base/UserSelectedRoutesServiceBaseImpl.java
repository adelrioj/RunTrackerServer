...
import es.eina.tfg.service.UserSelectedRoutesService;
...
/**
 * Provides the base implementation for the user selected routes remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link es.eina.tfg.service.impl.UserSelectedRoutesServiceImpl}.
 * </p>
 *
 * @author adelrioj
 ...
 * @generated
 */
public abstract class UserSelectedRoutesServiceBaseImpl extends BaseServiceImpl
	implements UserSelectedRoutesService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link es.eina.tfg.service.UserSelectedRoutesServiceUtil} to access the user selected routes remote service.
	 */
	...
	private UserSelectedRoutesServiceClpInvoker _clpInvoker = new UserSelectedRoutesServiceClpInvoker();
}