...
/**
 * Provides the base implementation for the user additional data remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link es.eina.tfg.service.impl.UserAdditionalDataServiceImpl}.
 * </p>
 *
 * @author adelrioj
 ...
 * @generated
 */
public abstract class UserAdditionalDataServiceBaseImpl extends BaseServiceImpl
    implements UserAdditionalDataService, IdentifiableBean {
    ...
    private UserAdditionalDataServiceClpInvoker _clpInvoker = new UserAdditionalDataServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link es.eina.tfg.service.UserAdditionalDataServiceUtil} to access the user additional data remote service.
     */
