...
import es.eina.tfg.service.PowerService;
...
/**
 * Provides the base implementation for the power remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link es.eina.tfg.service.impl.PowerServiceImpl}.
 * </p>
 *
 * @author adelrioj
 ...
 * @generated
 */
public abstract class PowerServiceBaseImpl extends BaseServiceImpl
	implements PowerService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link es.eina.tfg.service.PowerServiceUtil} to access the power remote service.
	 */
	...
	private PowerServiceClpInvoker _clpInvoker = new PowerServiceClpInvoker();
}