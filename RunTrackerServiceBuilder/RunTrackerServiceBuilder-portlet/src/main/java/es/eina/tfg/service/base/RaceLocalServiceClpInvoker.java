...
public class RaceLocalServiceClpInvoker {
    ...
    public RaceLocalServiceClpInvoker() {
        ...
        _methodName104 = "generateNewIdRace";

        _methodParameterTypes104 = new String[] {  };

        _methodName105 = "addRace";

        _methodParameterTypes105 = new String[] { "es.eina.tfg.model.Race" };

        _methodName106 = "updateRace";

        _methodParameterTypes106 = new String[] { "es.eina.tfg.model.Race" };

        _methodName108 = "getByUserId";

        _methodParameterTypes108 = new String[] { "java.lang.Long" };

        _methodName109 = "getLocations";

        _methodParameterTypes109 = new String[] { "long" };

        _methodName110 = "getPowerMeasurements";
