...
import es.eina.tfg.service.UserAndEventLocalService;
...
/**
 * Provides the base implementation for the user and event local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link es.eina.tfg.service.impl.UserAndEventLocalServiceImpl}.
 * </p>
 *
 * @author adelrioj
 ...
 * @generated
 */
public abstract class UserAndEventLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements UserAndEventLocalService,
        IdentifiableBean {
    ...
    private UserAndEventLocalServiceClpInvoker _clpInvoker = new UserAndEventLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link es.eina.tfg.service.UserAndEventLocalServiceUtil} to access the user and event local service.
     */
    ...
    public UserAndEvent addUserAndEvent(UserAndEvent userAndEvent)
        ...
        return userAndEventPersistence.update(userAndEvent);
    }
     ...
     */
    @Override
    public UserAndEvent createUserAndEvent(UserAndEventPK userAndEventPK) {
        return userAndEventPersistence.create(userAndEventPK);
    }
    ...
    @Override
    public UserAndEvent deleteUserAndEvent(UserAndEventPK userAndEventPK)
        throws PortalException, SystemException {
        return userAndEventPersistence.remove(userAndEventPK);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public UserAndEvent deleteUserAndEvent(UserAndEvent userAndEvent)
        throws SystemException {
        return userAndEventPersistence.remove(userAndEvent);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(UserAndEvent.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return userAndEventPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return userAndEventPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public UserAndEvent fetchUserAndEvent(UserAndEventPK userAndEventPK)
        throws SystemException {
        return userAndEventPersistence.fetchByPrimaryKey(userAndEventPK);
    }
     ...
     */
    @Override
    public UserAndEvent getUserAndEvent(UserAndEventPK userAndEventPK)
        throws PortalException, SystemException {
        return userAndEventPersistence.findByPrimaryKey(userAndEventPK);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return userAndEventPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<UserAndEvent> getUserAndEvents(int start, int end)
        throws SystemException {
        return userAndEventPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getUserAndEventsCount() throws SystemException {
        return userAndEventPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public UserAndEvent updateUserAndEvent(UserAndEvent userAndEvent)
        throws SystemException {
        return userAndEventPersistence.update(userAndEvent);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("es.eina.tfg.model.UserAndEvent",
            userAndEventLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "es.eina.tfg.model.UserAndEvent");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = userAndEventPersistence.getDataSource();
