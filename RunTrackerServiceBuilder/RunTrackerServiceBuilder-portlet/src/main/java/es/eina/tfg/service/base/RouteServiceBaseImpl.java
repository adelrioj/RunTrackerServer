...
import es.eina.tfg.service.RouteService;
...
/**
 * Provides the base implementation for the route remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link es.eina.tfg.service.impl.RouteServiceImpl}.
 * </p>
 *
 * @author adelrioj
 ...
 * @generated
 */
public abstract class RouteServiceBaseImpl extends BaseServiceImpl
    implements RouteService, IdentifiableBean {
    ...
    private RouteServiceClpInvoker _clpInvoker = new RouteServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link es.eina.tfg.service.RouteServiceUtil} to access the route remote service.
     */
