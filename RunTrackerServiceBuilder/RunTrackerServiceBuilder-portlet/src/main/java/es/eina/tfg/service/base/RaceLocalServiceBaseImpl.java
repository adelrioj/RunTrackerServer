...
import es.eina.tfg.service.RaceLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link es.eina.tfg.service.impl.RaceLocalServiceImpl}.
 * </p>
 *
 * @author adelrioj
 ...
 * @generated
 */
public abstract class RaceLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements RaceLocalService, IdentifiableBean {
    ...
    private RaceLocalServiceClpInvoker _clpInvoker = new RaceLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link es.eina.tfg.service.RaceLocalServiceUtil} to access the race local service.
     */
    ...
    @Override
    public Race addRace(Race race) throws SystemException {
        race.setNew(true);
     ...
     */
    @Override
    public Race createRace(long idRace) {
        return racePersistence.create(idRace);
    }
    ...
    @Override
    public Race deleteRace(long idRace) throws PortalException, SystemException {
        return racePersistence.remove(idRace);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Race deleteRace(Race race) throws SystemException {
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(Race.class,
    ...
    @Override
    public Race fetchRace(long idRace) throws SystemException {
        return racePersistence.fetchByPrimaryKey(idRace);
    }
     ...
     */
    @Override
    public Race getRace(long idRace) throws PortalException, SystemException {
        return racePersistence.findByPrimaryKey(idRace);
    }
     ...
     */
    @Override
    public List<Race> getRaces(int start, int end) throws SystemException {
     ...
     */
    @Override
    public int getRacesCount() throws SystemException {
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Race updateRace(Race race) throws SystemException {
        return racePersistence.update(race);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("es.eina.tfg.model.Race",
            raceLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "es.eina.tfg.model.Race");
    }
