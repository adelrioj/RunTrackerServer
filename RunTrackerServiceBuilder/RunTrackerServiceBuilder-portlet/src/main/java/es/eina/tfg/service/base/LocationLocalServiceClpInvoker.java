...
public class LocationLocalServiceClpInvoker {
    ...
    public LocationLocalServiceClpInvoker() {
        ...
        _methodName108 = "generateNewIdLocation";

        _methodParameterTypes108 = new String[] { "long" };

        _methodName109 = "createLocation";

        _methodParameterTypes109 = new String[] { "long", "long" };

        _methodName110 = "addLocation";

        _methodParameterTypes110 = new String[] { "es.eina.tfg.model.Location" };

        _methodName111 = "updateLocation";

        _methodParameterTypes111 = new String[] { "es.eina.tfg.model.Location" };

        _methodName112 = "deleteByIdRace";
