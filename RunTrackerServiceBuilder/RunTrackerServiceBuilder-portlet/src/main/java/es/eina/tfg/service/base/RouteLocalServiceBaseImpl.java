 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link es.eina.tfg.service.impl.RouteLocalServiceImpl}.
 * </p>
 *
 * @author adelrioj
...
public abstract class RouteLocalServiceBaseImpl extends BaseLocalServiceImpl
    implements RouteLocalService, IdentifiableBean {
    ...
    private RouteLocalServiceClpInvoker _clpInvoker = new RouteLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link es.eina.tfg.service.RouteLocalServiceUtil} to access the route local service.
     */
    ...
    @Override
    public Route addRoute(Route route) throws SystemException {
        route.setNew(true);
     ...
     */
    @Override
    public Route createRoute(long idRoute) {
        return routePersistence.create(idRoute);
    }
    ...
    @Override
    public Route deleteRoute(long idRoute)
        throws PortalException, SystemException {
        return routePersistence.remove(idRoute);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public Route deleteRoute(Route route) throws SystemException {
    ...
    @Override
    public Route fetchRoute(long idRoute) throws SystemException {
        return routePersistence.fetchByPrimaryKey(idRoute);
    }
     ...
     */
    @Override
    public Route getRoute(long idRoute) throws PortalException, SystemException {
        return routePersistence.findByPrimaryKey(idRoute);
    }
     ...
     */
    @Override
    public List<Route> getRoutes(int start, int end) throws SystemException {
     ...
     */
    @Override
    public int getRoutesCount() throws SystemException {
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public Route updateRoute(Route route) throws SystemException {
        return routePersistence.update(route);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("es.eina.tfg.model.Route",
            routeLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "es.eina.tfg.model.Route");
    }
