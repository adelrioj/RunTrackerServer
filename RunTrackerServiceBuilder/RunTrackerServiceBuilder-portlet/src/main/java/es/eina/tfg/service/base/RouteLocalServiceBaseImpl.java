...
public abstract class RouteLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 */
	@Override
	public Route createRoute(long routeId) {
		return routePersistence.create(routeId);
	}
	...
	public Route deleteRoute(long routeId)
		...
		return routePersistence.remove(routeId);
	}
	...
	@Override
	public Route fetchRoute(long routeId) throws SystemException {
		return routePersistence.fetchByPrimaryKey(routeId);
	}
	 ...
	 */
	@Override
	public Route getRoute(long routeId) throws PortalException, SystemException {
		return routePersistence.findByPrimaryKey(routeId);
	}
