...
public class PowerLocalServiceClpInvoker {
    ...
    public PowerLocalServiceClpInvoker() {
        ...
        _methodName108 = "generateNewIdPower";

        _methodParameterTypes108 = new String[] { "long" };

        _methodName109 = "addPower";

        _methodParameterTypes109 = new String[] { "es.eina.tfg.model.Power" };

        _methodName110 = "updatePower";

        _methodParameterTypes110 = new String[] { "es.eina.tfg.model.Power" };

        _methodName112 = "getByRaceId";
