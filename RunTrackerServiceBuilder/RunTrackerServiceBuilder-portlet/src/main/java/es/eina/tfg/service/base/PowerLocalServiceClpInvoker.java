...
public class PowerLocalServiceClpInvoker {
    ...
    public PowerLocalServiceClpInvoker() {
        ...
        _methodName102 = "generateNewIdPower";

        _methodParameterTypes102 = new String[] { "long" };

        _methodName103 = "addPower";

        _methodParameterTypes103 = new String[] { "es.eina.tfg.model.Power" };

        _methodName104 = "updatePower";

        _methodParameterTypes104 = new String[] { "es.eina.tfg.model.Power" };
