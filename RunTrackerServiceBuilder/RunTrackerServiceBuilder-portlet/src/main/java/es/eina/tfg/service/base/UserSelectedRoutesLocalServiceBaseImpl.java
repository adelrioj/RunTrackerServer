...
import es.eina.tfg.service.UserSelectedRoutesLocalService;
...
/**
 * Provides the base implementation for the user selected routes local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link es.eina.tfg.service.impl.UserSelectedRoutesLocalServiceImpl}.
 * </p>
 *
 * @author adelrioj
 ...
 * @generated
 */
public abstract class UserSelectedRoutesLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements UserSelectedRoutesLocalService,
        IdentifiableBean {
    ...
    private UserSelectedRoutesLocalServiceClpInvoker _clpInvoker = new UserSelectedRoutesLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link es.eina.tfg.service.UserSelectedRoutesLocalServiceUtil} to access the user selected routes local service.
     */
    ...
    @Override
    public UserSelectedRoutes addUserSelectedRoutes(
        UserSelectedRoutes userSelectedRoutes) throws SystemException {
        userSelectedRoutes.setNew(true);

        return userSelectedRoutesPersistence.update(userSelectedRoutes);
    }
     ...
     */
    @Override
    public UserSelectedRoutes createUserSelectedRoutes(
        UserSelectedRoutesPK userSelectedRoutesPK) {
        return userSelectedRoutesPersistence.create(userSelectedRoutesPK);
    }
    ...
    @Override
    public UserSelectedRoutes deleteUserSelectedRoutes(
        UserSelectedRoutesPK userSelectedRoutesPK)
        throws PortalException, SystemException {
        return userSelectedRoutesPersistence.remove(userSelectedRoutesPK);
    }
    ...
    public UserSelectedRoutes deleteUserSelectedRoutes(
        UserSelectedRoutes userSelectedRoutes) throws SystemException {
        return userSelectedRoutesPersistence.remove(userSelectedRoutes);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(UserSelectedRoutes.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return userSelectedRoutesPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return userSelectedRoutesPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public UserSelectedRoutes fetchUserSelectedRoutes(
        UserSelectedRoutesPK userSelectedRoutesPK) throws SystemException {
        return userSelectedRoutesPersistence.fetchByPrimaryKey(userSelectedRoutesPK);
    }
     ...
     */
    @Override
    public UserSelectedRoutes getUserSelectedRoutes(
        UserSelectedRoutesPK userSelectedRoutesPK)
        throws PortalException, SystemException {
        return userSelectedRoutesPersistence.findByPrimaryKey(userSelectedRoutesPK);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return userSelectedRoutesPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<UserSelectedRoutes> getUserSelectedRouteses(int start, int end)
        throws SystemException {
        return userSelectedRoutesPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getUserSelectedRoutesesCount() throws SystemException {
        return userSelectedRoutesPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public UserSelectedRoutes updateUserSelectedRoutes(
        UserSelectedRoutes userSelectedRoutes) throws SystemException {
        return userSelectedRoutesPersistence.update(userSelectedRoutes);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("es.eina.tfg.model.UserSelectedRoutes",
            userSelectedRoutesLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = userSelectedRoutesPersistence.getDataSource();
