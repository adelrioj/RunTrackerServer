...
/**
 * Provides the base implementation for the user additional data local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link es.eina.tfg.service.impl.UserAdditionalDataLocalServiceImpl}.
 * </p>
 *
 * @author adelrioj
 ...
 * @generated
 */
public abstract class UserAdditionalDataLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements UserAdditionalDataLocalService,
        IdentifiableBean {
    ...
    private UserAdditionalDataLocalServiceClpInvoker _clpInvoker = new UserAdditionalDataLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link es.eina.tfg.service.UserAdditionalDataLocalServiceUtil} to access the user additional data local service.
     */
    ...
    @Override
    public UserAdditionalData addUserAdditionalData(
        UserAdditionalData userAdditionalData) throws SystemException {
        userAdditionalData.setNew(true);

        return userAdditionalDataPersistence.update(userAdditionalData);
    }
     ...
     */
    @Override
    public UserAdditionalData createUserAdditionalData(long idUser) {
        return userAdditionalDataPersistence.create(idUser);
    }
    ...
    @Override
    public UserAdditionalData deleteUserAdditionalData(long idUser)
        throws PortalException, SystemException {
        return userAdditionalDataPersistence.remove(idUser);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public UserAdditionalData deleteUserAdditionalData(
        UserAdditionalData userAdditionalData) throws SystemException {
        return userAdditionalDataPersistence.remove(userAdditionalData);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(UserAdditionalData.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        ...
        return userAdditionalDataPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return userAdditionalDataPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public UserAdditionalData fetchUserAdditionalData(long idUser)
        throws SystemException {
        return userAdditionalDataPersistence.fetchByPrimaryKey(idUser);
    }
     ...
     */
    @Override
    public UserAdditionalData getUserAdditionalData(long idUser)
        throws PortalException, SystemException {
        return userAdditionalDataPersistence.findByPrimaryKey(idUser);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return userAdditionalDataPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<UserAdditionalData> getUserAdditionalDatas(int start, int end)
        throws SystemException {
        return userAdditionalDataPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getUserAdditionalDatasCount() throws SystemException {
        return userAdditionalDataPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public UserAdditionalData updateUserAdditionalData(
        UserAdditionalData userAdditionalData) throws SystemException {
        return userAdditionalDataPersistence.update(userAdditionalData);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("es.eina.tfg.model.UserAdditionalData",
            userAdditionalDataLocalService);
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = userAdditionalDataPersistence.getDataSource();
